...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v4}, Lcom/android/settings/inputmethod/InputMethodAndLanguageSettings;->addPreferencesFromResource(I)V
    ...
    :try_start_0
    invoke-virtual {p0, v4}, Lcom/android/settings/inputmethod/InputMethodAndLanguageSettings;->getString(I)Ljava/lang/String;
    ...
    iput v4, p0, Lcom/android/settings/inputmethod/InputMethodAndLanguageSettings;->mDefaultInputMethodSelectorVisibility:I
    :try_end_0
    .catch Ljava/lang/NumberFormatException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :goto_2
    iput-boolean v3, p0, Lcom/android/settings/inputmethod/InputMethodAndLanguageSettings;->mHaveHardKeyboard:Z
    ...
    iput-boolean v3, p0, Lcom/android/settings/inputmethod/InputMethodAndLanguageSettings;->mIsOnlyImeSettings:Z
    ...
    iput-object v3, p0, Lcom/android/settings/inputmethod/InputMethodAndLanguageSettings;->mImm:Landroid/view/inputmethod/InputMethodManager;
    ...
    iput-object v3, p0, Lcom/android/settings/inputmethod/InputMethodAndLanguageSettings;->mImis:Ljava/util/List;
    ...
    invoke-direct {p0, v3}, Lcom/android/settings/inputmethod/InputMethodAndLanguageSettings;->createImePreferenceHierarchy(Landroid/preference/PreferenceGroup;)V
    ...
    const-class v4, Lcom/android/settings/Settings$SpellCheckersSettingsActivity;
    ...
    check-cast v2, Lcom/android/settings/inputmethod/SpellCheckersPreference;

    .line 128
    .local v2, scp:Lcom/android/settings/inputmethod/SpellCheckersPreference;
    if-eqz v2, :cond_0

    .line 129
    invoke-virtual {v2, p0, v1}, Lcom/android/settings/inputmethod/SpellCheckersPreference;->setFragmentIntent(Lcom/android/settings/SettingsPreferenceFragment;Landroid/content/Intent;)V
    ...
    invoke-direct {v3, p0, v4, v5}, Lcom/android/settings/inputmethod/InputMethodAndLanguageSettings$SettingsObserver;-><init>(Lcom/android/settings/inputmethod/InputMethodAndLanguageSettings;Landroid/os/Handler;Landroid/content/Context;)V
    ...
    .end local v1           #intent:Landroid/content/Intent;
    .end local v2           #scp:Lcom/android/settings/inputmethod/SpellCheckersPreference;
    :cond_1
    ...
    iput-object v4, p0, Lcom/android/settings/inputmethod/InputMethodAndLanguageSettings;->mLanguagePref:Landroid/preference/Preference;
